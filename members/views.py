...
from .forms import SignUpForm,EditProfileForm,PasswordChangingForm,ProfilePageView,EditProfileFormPage
...
class CreateProfilePageView(generic.CreateView):
    ...
    template_name = 'registration/craete_user_profile_page.html' 
    # fields = '__all__'
